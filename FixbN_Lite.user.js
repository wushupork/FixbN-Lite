...
// @description	Fix BanniNation - per user options. see http://userscripts.org/scripts/show/36110 for original script.
// @version		1
// @downloadURL	https://userscripts.org/scripts/source/486742.user.js
// @updateURL	https://userscripts.org/scripts/source/486742.meta.js
...
(function ($) {
	...
	Nabbit = (function () {
		...
		Nabbit.prototype.update = function () {
			...
			var visClass = globalNabbitVisibility ? "nabbitOn" : "nabbitOff";
...
console.info("Fix bN Lite v" + GM_info.script.version);
